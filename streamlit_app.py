...
if st.button("🔮 Predict Next Step"):
    ...
    # -----------------------------
    instruction = f"""on{pred_date}DO NOT SHOW NUMBERS. Explain how each feature influenced tommorow’s stock price prediction. Use the SHAP importance values to describe whether a feature pushed the predicted price higher or lower 
